...
for ntime = 1:1:NTime
    ...
    [De_CellCtr,De_SignORS, CellGene] = CLBoo_ORSSig_DeCellCtr(SignORS,cellctr, CellConnectivity,  Cellid,  Ncell, CellGene, Vor_c, Vor_v);
...
StructTitleStr = ['CLBoo_ORSSig_WTBasDiv.mat'];
