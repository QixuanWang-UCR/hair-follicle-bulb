...
function ZeroAngle_FGF(nsim)
% clf; clear all; clc

load StructHFB_Prep.mat

global Idx_Epi Idx_Fan Idx_DP Idx_Blue DP_b DP_t d0
...
for ntime = 1:1:NTime
    ...
    [De_CellCtr, De_SignFgf] = HFBulb_DeDyn(cellctr, CellConnectivity, Cellid, SignFgf, Ncell,Vor_c, Vor_v );
...
StructTitleStr = ['ZeroAngle_FGF_1.5alpha' num2str(nsim) '.mat'];
