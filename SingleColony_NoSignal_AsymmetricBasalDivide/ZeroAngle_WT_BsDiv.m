function ZeroAngle_WT_BsDiv(nsim)
...
NSaveTime = 100;
NTime =200000;%origninally was 100000
dt = 0.01;
...
for ntime = 1:1:NTime
    ...
    for ncell = 1:1:Ncell
        ...
        if Cellid(ncell)==Idx_Epi && celltime(ncell)<=0 && AtchDP == 1
            ...
            elseif Cellid(ncell)==Idx_Blue && celltime(ncell)<=0 && AtchDP == 1
...
StructTitleStr = ['ZeroAngle_WT_BsDiv' num2str(nsim) '.mat']; 
