...
function CL_HFBulb_FGF_Homo(nsim)
% clf; clear all; clc
...
for ntime = 1:1:NTime
    ...
    [De_CellCtr, De_SignFgf, CellClr] = HFBulb_DeDyn_Homo(cellctr, CellConnectivity, Cellid, SignFgf, Ncell,Vor_c, Vor_v, CellClr );
...
%                 axis([0,8,-2,10])
% 
% %                 SaveFig = ['HFB_FGF_Homo_' num2str(nsim) '_T' num2str(Time) '.pdf'];
% %                 exportgraphics(gcf,SaveFig,'ContentType','vector')
%         %         
%         %         
%         %         figure(2)
%         %         clf
...
StructTitleStr = ['CL_StructHFB_FGF_Homo_Revised' num2str(nsim) '.mat'];
