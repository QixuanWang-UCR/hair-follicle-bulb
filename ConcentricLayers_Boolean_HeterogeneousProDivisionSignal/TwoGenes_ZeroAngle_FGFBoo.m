...
function TwoGenes_ZeroAngle_FGFBoo(s_str, NBool)
% clf; clear all; clc
...
for ntime = 1:1:NTime
    ...
    [De_CellCtr, De_SignFgf, CellGene] = TwoGenes_DeCellCtr_FGF(cellctr, CellConnectivity, Cellid, SignFgf, Ncell,Vor_c, Vor_v, CellGene, ntime, s_str, NBool);
...
StructTitleStr = ['TwoGenes_ZeroAngle_FGFBoo_NBool_' num2str(NBool) '_SStr_' num2str(s_str) '.mat'];
