function [De_CellCtr, De_SignFgf] = HFBulb_DeDyn_Homo(cellctr, CellConnectivity, Cellid, SignFgf, Ncell,Vor_c, Vor_v )

global Idx_Epi  Idx_Fan Idx_DP DP_b DP_t
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%parameters
Mu_r = 15;
Mu_a = 3;
...
for ncell = 1:1:Ncell
    ...
    if  Cellid(ncell)==Idx_Fan 
        ...
        for mcell = 1:1:length(lind)
            ...
            if Cellid(m_cell_id)==Idx_Fan || cellctr(ncell,2)>11 || norm(CellVec)<0.1*d0
            else
